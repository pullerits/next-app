        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="block text-blue-300">Ultra-Secure.</span>
            </h1>
            ...
            <Link href="/products" className="inline-block bg-blue-500 hover:bg-blue-600 hover:scale-105 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 shadow-lg">
              SHOP NOW
            </Link>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-4 bg-black rounded-xl shadow-2xl flex items-center justify-center">
                <Image
